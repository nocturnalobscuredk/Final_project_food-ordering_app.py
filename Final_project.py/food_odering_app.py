...
# The admin will have the following functionalities:
    ...
    def admin_login(self):
        try:
            ...
            if len(self.admin_details.values())!=0:
                ...
                print("\n! There is no any Admin Account with this Email ID !\n\n!! Please Create Your Account First!!\n")
        except Exception as e:
            print("\n!! Please Provide Valid Inputs !!")
    
    def add_food_item(self):
        try:
            name=input("Enter the food name please : ")
            ...
            print("Newly Added items are :", self.food,"\n")
        except Exception as e:
            print("\n!! Please Provide Valid Inputs !!\n")

    def edit_food_item(self):
        try:
            x=int(input("Enter the Food ID that you want to update : \n"))
            if x in self.food.keys():
                print("1. Update Food Name\n2. Update Quantity\n3. Update Price\n4. Update Discount\n5. Update Stock \n")
                y= input("Enter the number only : ")
                if y=="1":
                    self.food[x]["Name"]=input("Updated the Food item name : ")
                    print("\n!! Successfully Updated !!\n")
                elif y=="2":
                    self.food[x]["Quantity"]=float(input("Updated the Quantity in values only : "))
                    print("\n!! Successfully Updated !!\n")
                elif y=="3":
                    self.food[x]["Price"]=float(input("Updated the Price in Rs only : "))
                    print("\n!! Successfully Updated !!\n")
                elif y=="4":
                    self.food[x]["Discount"]=float(input("Updated the Discount in Rs only : "))
                    print("\n!! successfully Updated !!\n")
                elif y=="5":
                    self.food[x]["Stock"]=float(input("Updated the Stock in values only : "))
                    print("\n!! Successfully Updated !!\n")
                else:
    ...
    def delete_food_item(self):
        try:
            print("!! Remove a food item from the menu using FoodID.\n")
...
# The user will have the following functionalities:
    ...
    def user_register(self):
        try:
            ...
            self.user_details={"User Name":user_name,"Phone No.":phone_no,"Email_ID":email,"Address":address,"Password":password}
        ...
        try:
            if len(self.food)!=0:
                ...
                while True:
                    ...
                    x=input()
                    if x=="1":
                        print("Enter the Food number that You want to ordered separated by comma")
                        y=input().split(",")
                        for i in y:
                            z=int(i)
                            if z<=len(menu):
                                ...
                                print("\nWe don't have this Food Items in our menu: ",z)
                        print("\nList of food items you selected : \n")
    ...
    def update_details(self):
        try:
            while True:
                print("Select the Options given below to Update Your Profile Details\n")
                print("1. Name\n2. Phone number\n3. Email ID\n4. Password\n5. Address\n6. Exit\n")
                x=input()
                if x=="1":
...
# We defining the Main function below:    

try:
    def main():
        obj=Restaurant("EDYODA")
        print("!!----------------------------------------------------------\n")
        print(f"\n$************!!  Welcome To {obj.restro_name} Restaurant  !!************$\n")
        print("\n-----------------------------------------------------------!!\n")
    ...
    print("Something going wrong please provide right input")
            
        
# We calling the main function below:
